...
with(relevantdata, plot(Voltage ~ DateTime, 
                          type = "l", 
                          xlab = "datetime", 
                          ylab = "Voltage"))
...
with(relevantdata, plot(DateTime, Sub_metering_1, 
                        type = "l",
                        col = "black",
                        xlab = "", 
                        ylab = "Energy sub metering"))

with(relevantdata, lines(DateTime, Sub_metering_2,
                         type = "l",
                         col = "red"))

with(relevantdata, lines(DateTime, Sub_metering_3,
                         type = "l",
                         col = "blue"))
...
with(relevantdata, plot(Global_reactive_power ~ DateTime, 
                        type = "l", 
                        xlab = "datetime"))
